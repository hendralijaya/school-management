...
namespace App\OpenApi\Schemas\API\v1\Siswa;
...
class UpdateSiswaSchema extends SchemaFactory implements Reusable
{
    /**
    ...
    {
        return Schema::object('UpdateSiswa')
            ->properties(
                Schema::string('nama')->required(),
                Schema::string('no_wa')->required(),
                Schema::string('gender')->required()->enum('M', 'F'),
                ...
                Schema::integer('orang_tua_id')->required(),
            );
    }
}
